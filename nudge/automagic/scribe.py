...
from nudge.utils import Dict, hump, breakup_function_path
...
class AutomagicGenerator(object):
    ...
    def __init__(self, dir='/tmp', module='autogenerated_output'):
        self.dir = dir
        self.module = module
        self.output_file = self._filepath(self.module)
    ...
    def _prepare_data(self, project):
        ...
        for module, classes in modules.iteritems():
            ...
            for class_name, endpoints in classes.iteritems():
                ...
                module_dict.classes.extend([{"name":class_name if class_name else False, "endpoints":data}])
